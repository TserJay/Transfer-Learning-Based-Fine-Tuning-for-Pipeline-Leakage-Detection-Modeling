...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, layers, baseWidth = 26, scale = 2, num_classes=1000):
        ...
        self.BiLSTM1 = nn.GRU(input_size=897,
                               hidden_size=448,
                               num_layers=1,
                               batch_first=True,
                               bidirectional=True,
        ...
        self.BiLSTM2 = nn.GRU(input_size=448,
                               hidden_size=224,
                               num_layers=1,
                               batch_first=True,
                               bidirectional=True,
        ...
        self.BiLSTM3 = nn.GRU(input_size=224,
                               hidden_size=112,
                               num_layers=1,
                               batch_first=True,
                               bidirectional=True,
        ...
        self.BiLSTM4 = nn.GRU(input_size=112,
                               hidden_size=64,
                               num_layers=1,
                               batch_first=True,
                               bidirectional=True,
    ...
    def forward(self, x, adapter_name):
        ...
        x = self.bn1(x)
        z = x = self.relu(x)  #  plus with target_lora funt    ([32, 64, 897])
...
#     
        ...
        x = self.layer4(x)
        x,_ = self.BiLSTM4(x.permute(1, 0, 2))  ##  ([32, 32, 128])
...
class LORA_Net_12345_GRU(nn.Module): 
    def __init__(self,  in_channel=3, kernel_size=3, in_embd=64, d_model=32, in_head=8, num_block=1, dropout=0, d_ff=128, out_num=12):
        ...
        '''
        super(LORA_Net_12345_GRU, self).__init__()
