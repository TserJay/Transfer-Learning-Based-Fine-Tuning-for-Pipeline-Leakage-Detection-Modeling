...
from wd import WaveletGatedNet
#from models.wd import WaveletGatedNet
...
class LORA_Net_12345_wd(nn.Module): 
    def __init__(self,  in_channel=3, kernel_size=3, in_embd=64, d_model=32, in_head=8, num_block=1, dropout=0, d_ff=128, out_num=12):
        ...
        '''
        super(LORA_Net_12345_wd, self).__init__()


        self.wd = WaveletGatedNet(signal_length=1792, wavelet_name='db1',level=8)
