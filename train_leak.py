...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='MSF_LoraNet', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='leak_signals_TL', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default=r'D:\projects\Transfer-Learning-Based-Fine-Tuning-for-Pipeline-Leakage-Detection-Modeling\data\leak_signals', help='the directory of the data')
    parser.add_argument('--transfer_task', type=list, default=[[0] ,[1], [2], [3]], help='transfer learning tasks')
    parser.add_argument('--task', type=str, default='2-013test', help='transfer learning tasks')
